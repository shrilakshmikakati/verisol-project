...
/// @title etidhanush — Auto-generated from E-Contract KG
...
contract etidhanush {
    ...
    address public Internship_Dear_Candidate;
    ...
    modifier onlyParty() { require(msg.sender==Professor || msg.sender==Candidate || msg.sender==Intern || msg.sender==Sangharatna_GodboleyDt || msg.sender==ETI_DHANUSH || msg.sender==Sangharatna_Godboley || msg.sender==India || msg.sender==Telangana || msg.sender==Sangharatna_GodboleyDt_08_07_202 || msg.sender==Internship_Dear_Candidate||msg.sender==owner,'Not a party'); _; }
    ...
    constructor(
        ...
        uint256 _liabilityCap, address _Professor, address _Candidate, address _Intern, address _Sangharatna_GodboleyDt, address _ETI_DHANUSH, address _Sangharatna_Godboley, address _India, address _Telangana, address _Sangharatna_GodboleyDt_08_07_202, address _Internship_Dear_Candidate,
	...
	assert(!(!(_endDate>_startDate)));
        ...
        Internship_Dear_Candidate=_Internship_Dear_Candidate;
