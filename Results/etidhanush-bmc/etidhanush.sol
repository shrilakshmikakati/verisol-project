...
contract etidhanush {
    ...
    modifier onlyParty() { require(msg.sender==Professor || msg.sender==Candidate || msg.sender==Intern || msg.sender==Sangharatna_GodboleyDt || msg.sender==ETI_DHANUSH || msg.sender==Sangharatna_Godboley||msg.sender==owner,'Not a party'); _; }
    ...
    constructor(
        ...
        uint256 _liabilityCap, address _Professor, address _Candidate, address _Intern, address _Sangharatna_GodboleyDt, address _ETI_DHANUSH, address _Sangharatna_Godboley,
